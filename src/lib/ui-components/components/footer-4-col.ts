...
const code = `<footer class="bg-zinc-950 border-t border-zinc-800">
  <div class="max-w-7xl mx-auto px-6 py-16">
    <div class="grid md:grid-cols-5 gap-8">
      ...
      <div class="md:col-span-2">
        ...
        <p class="text-zinc-400 mb-6 max-w-xs">
          Building the future of web design with AI-powered tools.
        </p>
        <div class="flex gap-4">
          <a href="#" class="w-10 h-10 rounded-lg bg-zinc-900 flex items-center justify-center text-zinc-400 hover:text-white hover:bg-zinc-800 transition">
      ...
      <div>
        ...
        <ul class="space-y-3">
          ...
          <li><a href="#" class="text-zinc-400 hover:text-white transition">Changelog</a></li>
          <li><a href="#" class="text-zinc-400 hover:text-white transition">Roadmap</a></li>
        </ul>
      </div>
      <div>
    ...
    <!-- Bottom Bar -->
    <div class="mt-16 pt-8 border-t border-zinc-800 flex flex-col md:flex-row justify-between items-center gap-4">
      <p class="text-zinc-500 text-sm">© 2024 Brand. All rights reserved.</p>
      <div class="flex gap-6 text-sm">
        <a href="#" class="text-zinc-500 hover:text-white transition">Privacy Policy</a>
        <a href="#" class="text-zinc-500 hover:text-white transition">Terms of Service</a>
      </div>
    </div>
  </div>
</footer>`;

export const FOOTER_4_COL: UIComponent = {
  id: "footer-4-col",
  name: "Footer 4 Columns",
  description: "Footer with brand column and 3 link columns",
  category: "footer",
